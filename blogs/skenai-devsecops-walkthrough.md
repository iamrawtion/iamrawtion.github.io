---
title: "Sken.ai DevSecOps walkthrough"
date: "2021-01-22"
category: "DevOps"
tags: []
excerpt: "Sken.ai Introduction:- Sken.ai is a Continuous Application Security Testing and vulnerability scanning tool. It helps in static code analysis, Source..."
...
The Code Review Tools automates the review process which in turn minimizes the reviewing task of the code.

It provides free scanning forever for single users, Unlimited tests on open source projects, 300 tests per month across all apps on private projects, Priority Scoring, and Continuous Monitoring.
...
It provides open-source scanners packaged and managed, There's No need to set up, install or update scanners.
...
Sken.ai applies machine learning and data science to normalize and prioritize all the application security issues found across testing categories.

It provides AI-Based Analysis, and it reduces noise up to 97%.
...
Traditional security scanners are proprietary, expensive, and difficult to use.
They also need a team of app sec specialists to operate them, thus adding to the total cost.
Sken.ai uses an innovative approach that uses a combination of popular, effective, and widely used open source security scanners to dramatically reduce the cost.

Sken.ai provides free scanning forever for single users, Unlimited tests on open source projects, 300 tests per month across all apps on private projects, Priority Scoring, and Continuous Monitoring.
...
A web application security scanner is a software program that performs automatic black-box testing on a web application and identifies security vulnerabilities.
...
Penetration testing in simple terms is a simulation of a process a hacker would use to launch an attack on a business network, attached devices, network applications, or a business website.
...
Mobile application security testing involves testing a mobile app in ways that a malicious user would try to attack it.

Effective security testing begins with an understanding of the application’s business purpose and the types of data it handles.

From there, a combination of static analysis, dynamic analysis, and penetration testing results in an efficient holistic assessment to find vulnerabilities that would be missed if the techniques were not used together effectively.
...
5. [Detectify Deep Scan](https://detectify.com/)
6. [SonarQu](https://www.sonarqube.org/)be
7. [Fortify Static Code Analyz](https://www.microfocus.com/en-us/products/static-code-analysis-sast/overview)er
8. [AppSc](https://www.hcltechsw.com/products/appscan)an
9. [Checkmar](https://www.checkmarx.com/)x
10. [Syn](https://snyk.io/)k

- SAST Scanning Tools:-

1. [SonarQube](https://www.sonarqube.org/)
2. [veracode](https://www.veracode.com/)
3. [Fortify Static Code Analyzer](https://www.microfocus.com/en-us/products/static-code-analysis-sast/overview)
4. [AppScan](https://www.hcltechsw.com/products/appscan)
5. [Brakeman](https://brakemanscanner.org/)
6. [Code Climate](https://codeclimate.com/)
7. [bundler-audit](https://github.com/rubysec/bundler-audit)
8. [codacy](https://www.codacy.com/)
9. [VisualCodeGrepper](https://sourceforge.net/projects/visualcodegrepp/)
10. [RIPS (Re-Inforce Programming Security)](https://www.ripstech.com/)
11. [Flawfinder](https://pypi.org/project/flawfinder/)
12. [Bandit](https://pypi.org/project/bandit/)

- Combine Scanning (SAST/DAST/SCA) tools and alternative to sken.ai tools:-

1. [Checkmarx](https://www.checkmarx.com/)
2. [veracode](https://www.veracode.com/)
3. [Detectify Deep Scan](https://detectify.com/)
4. [AppScan](https://www.hcltechsw.com/products/appscan)
5. [SonarQube](https://www.sonarqube.org/)
6. [Pycharm](https://www.jetbrains.com/pycharm/)
7. [Sucuri](https://sucuri.net/)
8. [Pentest-Tools](https://pentest-tools.com/home)
9. [Netsparker](https://www.netsparker.com/)
10. [OWASP ZAP](https://owasp.org/www-project-zap/)
11. [Acunetix](https://www.acunetix.com/)
12. [Prospector](http://prospector.landscape.io/en/master/)
13. [pylint](https://pypi.org/project/pylint/)
14. [Pyflakes](https://pypi.org/project/pyflakes/)
15. [Bandit](https://pypi.org/project/bandit/)
16. [Snyk](https://snyk.io/)
17. [Burp Suite](https://portswigger.net/burp)
18. [Grabber](https://tools.kali.org/web-applications/grabber)
19. [Arachni](https://www.arachni-scanner.com/)
20. [w3af](http://w3af.org/)
21. [Nikto](https://geekflare.com/nikto-webserver-scanner/)
22. [JavaScript Lint](http://www.javascriptlint.com/)
23. [ESLint](https://eslint.org/)
24. [Flow](https://flow.org/)
25. [JSHint](https://jshint.com/)
26. [Intruder](https://www.intruder.io/)
27. [Nikto2](https://cirt.net/Nikto2)
28. [Gerrit](https://www.gerritcodereview.com/)
29. [Crucible](https://www.atlassian.com/software/crucible)
30. [Codacy](https://www.codacy.com/)
31. [Nessus](https://www.tenable.com/products/nessus/nessus-professional)
32. [Resharper](https://www.jetbrains.com/resharper/)
33. [Appkno](https://www.appknox.com/static-application-security-testing)x
34. [CodeSona](https://valbrio.com/products/codesonar/)r
35. [Wireshark](https://www.wireshark.org/)
36. [SQLmap](http://sqlmap.org/)
37. [Selenium](https://www.selenium.dev/)
38. [JOHN THE RIPPER](https://www.openwall.com/john/)
39. [Suricata](https://suricata-ids.org/)
40. [Grapl](https://www.graplsecurity.com/)
...
3. [Acunetix](https://www.acunetix.com/)
4. [Nessus](https://www.tenable.com/products/nessus/nessus-professional)
...
    I have used the [sken.a](https://bit.ly/2XfPgkZ)i scanning tool, I have mentioned some features which I liked, 
