...
[MDWiki](http://dynalon.github.io/mdwiki/#!index.md) is simple to setup, you don't need any software to install.

They are files you place in your file system that could be shared over Network through any medium.
The user may only need to click on the index page and the wiki opens up with the best looking UI.
Get the source code for MDWiki from [here](https://github.com/Dynalon/mdwiki/releases).
You will see that they are basically just 3 HTML files.
You need to keep these 3 files intact and just create your own configuration and webpages with .md extension.

You can use markdown syntax to add details in the page.
