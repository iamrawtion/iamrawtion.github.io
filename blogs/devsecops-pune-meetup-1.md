...
After some good success, a huge gap and some mixed learning experiences with organizing [DevOps Pune](https://www.meetup.com/DevOps-Pune/members/?op=leaders) meetups, I decided to start with [DevSecOps Pune](https://www.meetup.com/DevSecOps-Pune/members/?op=leaders) meetup. This was mainly since I was exploring possibilities in Information Security world. The idea started after seeing [DevSecOps Seattle](https://www.meetup.com/Seattle-DevSecOps/) Meetup and the learning experience I had their simply by reading their updates. I saw regular posts on Facebook about this meetup group from my long time mentor [Archis Gore](https://www.linkedin.com/in/archis). I was still confused whether to start a meetup in Pune or just stick to Seattle meetup and attend it virtually. You don't always have to be an organizer to learn.  
  
However, Archis told me that the Seattle meetup could not be attended virtually, as the format could not support virtual attendance. This was a Lean Coffee format. Something different for me. On learning more about the format, it sounded really like a plan to start a similar meetup in Pune. Archis was here in Pune in October 2018, when I met him to understand the organizer's roles in this format. And then, and we were in or a great start. I got [Rahul Khengare](https://in.linkedin.com/in/rahulkhengare) with me this time as a Co-organizer and started the meetup group. [Cloudneeti](https://www.cloudneeti.com/) helped us sponsor the meetup group.  
